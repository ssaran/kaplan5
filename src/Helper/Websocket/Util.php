...
class Util
{
     ...
     * @param $bind
     * @param $cbcd
     * @return \Common\Websocket\Entity\Event
     */
    public static function GetEventBase($token,$from="",$to="",$type="",$destinationFd="",$sourceFd="",
        ...
        ) : \Common\Websocket\Entity\Event
    {
        $event = new \Common\Websocket\Entity\Event();
        $event->type = $type;
        $event->content = new \Common\Websocket\Entity\EventBody();
        ...
        $event->content->content = new \Common\Websocket\Entity\EventBodyContent();
