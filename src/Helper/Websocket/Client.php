...
\*----------------------------------------------------------------------------*/
    ...
    \*============================================================================*/
    public static function WebsocketOpen($host='',$port=80,$headers='',&$error_string='',$timeout=10,$ssl=false, $persistent = false, $path = '/', $context = null){
    ...
    \*============================================================================*/
    public static function WebsocketWrite($sp,$data,$final=true,$binary=true){
        ...
        if(strlen($data)<126) {
            ...
            $header.= WSC . phpchr(0x80 | 126);
        }  else {
            $header.= WSC . phpchr(0x80 | 127) . pack("N",strlen($data));
        }
    ...
    public static function WebsocketRead($sp,&$error_string=NULL){
        ...
        do{
            ...
            if($opcode == 9){
                ...
                fwrite($sp, WSC . phpchr(0x8A) . pack("N", rand(1,0x7FFFFFFF)));
                continue;
